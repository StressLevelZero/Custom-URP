...
// SLZ MODIFIED // Packing.hlsl contains octahedral packing functions
...
{
    // SLZ MODIFIED // Replace xyz normals with octahedral coordinates
    /*
    ...
    */
    ...
    half2 octNormal = SAMPLE_TEXTURE2D_X(_CameraNormalsTexture, sampler_CameraNormalsTexture, UnityStereoTransformScreenSpaceTex(uv)).xy;
...
float3 LoadSceneNormals(uint2 uv)
{
    ...
    half2 octNormal = LOAD_TEXTURE2D_X(_CameraNormalsTexture, uv).xy;
    half3 normal = UnpackNormalOctQuadEncode(octNormal);
