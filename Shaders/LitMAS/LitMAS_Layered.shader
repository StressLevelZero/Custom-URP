...
Shader "SLZ/LitMAS/LitMAS Layered"
{
    ...
    SubShader
    {
        ...
        #define CBUFFER_PATH "Packages/com.unity.render-pipelines.universal/Shaders/LitMAS/LitMASInclude/ShaderInjector/LayeredCBuffer.hlsl"
        ENDHLSL
        ...
        Pass
        {
            ...
            #include_with_pragmas "Packages/com.unity.render-pipelines.universal/Shaders/LitMAS/LitMASInclude/ShaderInjector/LayeredForward.hlsl"
