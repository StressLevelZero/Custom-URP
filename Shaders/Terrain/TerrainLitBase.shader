Shader "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.slz.rendering/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Packages/com.slz.rendering/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.slz.rendering/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Packages/com.slz.rendering/Shaders/Terrain/TerrainLitMetaPass.hlsl"
