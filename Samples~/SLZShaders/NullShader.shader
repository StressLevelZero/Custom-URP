...
ENDHLSL
		...
		Pass
		{
			...
			#include "../../../../Shaders/Includes/PosespaceImpacts.hlsl"
			...
			{
				return  PosespaceImpacts( Posespace, EllipsoidPosArray , _NumberOfHits );
			}
						 ...
						 ) : SV_Target
			{
				...
				half4 localSampleHitTexture137 = SampleHitTexture( ImpactsUV137 );
				float temp_output_144_0 = min( (localSampleHitTexture137).w , ( 1.0 - floor( (localPosespaceImpacts_A29).x ) ) );
				...
				float3 Emission = ( ( localSampleHitTexture137 * temp_output_144_0 ) + lerpResult160 ).xyz;
#if 0
...
/*ASEBEGIN
Version=18935
2103;205;1980;1007;114.0071;839.9831;1.221117;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;123;464.7832,-647.4188;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=343EC70514B36F02E79DA2BA1D6F0C6F5EA4A24C