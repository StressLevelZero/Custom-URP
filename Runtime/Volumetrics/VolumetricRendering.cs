...
public class VolumetricRendering : MonoBehaviour
{
    ...
    [Tooltip("Use Tricubic Sampling")]
    public const bool HighQualitySampling = true;
    
    public float _bakedTurbulence = 5f;
    public bool _Panic = false;
...
//         
//         FroxelFogCompute.SetBool("_Panic",_Panic);
//     }
//
//
...
//                 _PrevViewProjMatrix_L = PrevViewProjMatrix,
//                 _ViewMatrix_L = activeCam.worldToCameraMatrix,
...
//             };
//             
//            // Shader.SetGlobalMatrix("_VBufferCoordToViewDirWS", PixelCoordToViewDirWS); //testing moving mipfog
//             
