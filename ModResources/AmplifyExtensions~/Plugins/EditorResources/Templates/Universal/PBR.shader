Shader /*ase_name*/ "Hidden/Universal/PBR" /*end*/
{
	...
	SubShader
	{
		...
		/*ase_subshader_options:Name=Additional Options
			...
			Option:GPU Instancing:false,true:false
			...
			Option:Lightmaps:false,true:true
				true:RemoveDefine:_DISABLE_LIGHTMAPS
				false:SetDefine:_DISABLE_LIGHTMAPS
			Option:Volumetrics:false,true:true
				true:SetDefine:pragma multi_compile_fragment _ _VOLUMETRICS_ENABLED
				false:RemoveDefine:pragma multi_compile_fragment _ _VOLUMETRICS_ENABLED	
			Option:Decals:false,true:false
				true:SetDefine:pragma multi_compile_fragment _ _DBUFFER_MRT1 _DBUFFER_MRT2 _DBUFFER_MRT3
				false:RemoveDefine:pragma multi_compile_fragment _ _DBUFFER_MRT1 _DBUFFER_MRT2 _DBUFFER_MRT3
			Option:Screen Space Occlusion:false,true:true
				true:RemoveDefine:_DISABLE_SSAO
				false:SetDefine:_DISABLE_SSAO
			Option:Reflection Probe Blend/Projection:false,true:true
				true:RemoveDefine:_DISABLE_REFLECTIONPROBES
				false:SetDefine:_DISABLE_REFLECTIONPROBES
			Option:Light Layers:false,true:false
				true:SetDefine:pragma multi_compile_fragment _ _LIGHT_LAYERS
				false:RemoveDefine:pragma multi_compile_fragment _ _LIGHT_LAYERS
			...
			Option:GBuffer Pass:false,true:false
				true:IncludePass:GBuffer
				false,disable:ExcludePass:GBuffer
			...
			Option:Clear Coat:false,true:false
				...
				false,disable:IncludePass:GBuffer
			Option:Fluorescence:false,true:false
				true:ShowPort:Forward:Fluorescence
				true:ShowPort:Forward:Absorbance
				true:SetDefine:_FLUORESCENCE 1
				true:SetPropertyOnPass:Forward:ChangeTagValue,LightMode,UniversalForwardOnly
				true:SetPropertyOnPass:DepthNormals:ChangeTagValue,LightMode,DepthNormalsOnly
				true:ExcludePass:GBuffer
				false,disable:HidePort:Forward:Fluorescence
				false,disable:HidePort:Forward:Absorbance
				false,disable:RemoveDefine:_FLUORESCENCE 1
				false,disable:SetPropertyOnPass:Forward:ChangeTagValue,LightMode,UniversalForward
				false,disable:SetPropertyOnPass:DepthNormals:ChangeTagValue,LightMode,DepthNormals
				false,disable:IncludePass:GBuffer
		...
		*/
		...
		Pass
		{
						...
						/*ase_frag_input*/ ) : SV_Target
			{
...
#if 0
				float3 BakedEmission = /*ase_frag_out:Baked Emission;Float3;20;-1;_EmissionBaked*/0/*end*/;
#endif
				...
				float CoatSmoothness = /*ase_frag_out:Coat Smoothness;Float;19;-1;_CoatSmoothness*/0/*end*/;
				#endif

				#if defined(_FLUORESCENCE)
				float4 Fluorescence = /*ase_frag_out:Fluorescence;Float4;21;-1;_Fluorescence*/0/*end*/;
				float4 Absorbance = /*ase_frag_out:Absorbance;Float4;22;-1;_Absorbance*/0/*end*/;
				#endif
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN /*ase_frag_input*/ ) : SV_TARGET
			{
				...
				float3 Albedo = /*ase_frag_out:Albedo;Float3;0;-1;_Albedo*/float3(0.5, 0.5, 0.5)/*end*/;
				float3 Emission = /*ase_frag_out:Baked Emission;Float3;20;-1;_EmissionBaked*/0/*end*/;
