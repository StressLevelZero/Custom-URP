	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Built-in Fog:false,true:false
				...
				true:SetDefine:ASE_NEEDS_FRAG_WORLD_POSITION
				false:RemoveDefine:ASE_NEEDS_FRAG_WORLD_POSITION
			Option:Volumetrics:false,true:false
		...
		*/
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN /*ase_frag_input*/ ) : SV_Target
			{
				...
				#endif
				/*ase_frag_code:IN=VertexOutput*/
				half3 BakedAlbedo = /*ase_frag_out:Baked Albedo;Float3;0;-1;_Albedo*/0/*end*/;
				half3 BakedEmission = /*ase_frag_out:Baked Emission;Float3;1;-1;_Emission*/0/*end*/;
				half3 Color = /*ase_frag_out:Color;Float3;2;-1;_Color*/float3( 0.5, 0.5, 0.5 )/*end*/;
				half Alpha = /*ase_frag_out:Alpha;Float;3;-1;_Alpha*/1/*end*/;
				half AlphaClipThreshold = /*ase_frag_out:Alpha Clip Threshold;Float;4;-1;_AlphaClip*/0.5/*end*/;
				half AlphaClipThresholdShadow = /*ase_frag_out:Alpha Clip Threshold Shadow;Float;7;-1;_AlphaClipShadow*/0.5/*end*/;
